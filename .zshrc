...
alias work='aerospace move-node-to-workspace P && aerospace workspace P && wv && nvim dashboard.md'
alias pv='cd ~/vaults/personal'
alias life='aerospace move-node-to-workspace P && aerospace workspace P && pv && nvim dashboard.md'
